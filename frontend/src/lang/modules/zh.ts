...
const message = {
    ...
    xpack: {
        tamper: {
            ...
            ignore: '排除目录',
            ignoreHelper: '一行一个，例： \ntmp\n./tmp',
            ignoreHelper1: '可添加防篡改时忽略的文件夹名或者指定文件夹',
            ignoreHelper2: '当需忽略指定文件夹时，需要添加以 ./ 开头的相对路径',
            protect: '保护',
            protectHelper: '一行一个，例： \npng\n./test.css',
            protectHelper1: '可添加保护的文件名、后缀名或者指定文件',
            protectHelper2: '当保护指定文件时，需要添加以 ./ 开头的相对路径',
            enableHelper: '当前操作将启用站点 {0} 防窜改，提升站点安全性，是否继续？',
            disableHelper: '当前操作将关闭站点 {0} 防窜改（建议开启），是否继续？',
        },
    },
};
export default {
